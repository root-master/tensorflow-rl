...
def get_config():
    ...
    parser.add_argument('--density_model_update_steps', default=200000, type=int, help='density_model_update_steps')
    parser.add_argument('--replay_size', default=100000, type=int, help='Maximum capacity of replay memory', dest='replay_size')
    parser.add_argument('--replay_memonly', action='store_true', help='Replay memory with no mmap', dest='replay_memonly')
